...
#define _C34F_TAU_TDR06_VALUE                   (0xC34FU)
/* Clock divisor for TAU0 channel 6 */
#define _0040_TAU0_CHANNEL6_DIVISOR             (0x0040U)
